//! aiobscura-debug-codex - Codex CLI parser debugging tool
//!
//! Parses Codex CLI log files and outputs canonical format for debugging.
...
#[derive(Parser)]
#[command(name = "aiobscura-debug-codex")]
#[command(about = "Parse Codex CLI logs and output canonical format")]
#[command(version)]
struct Args {
...
fn parse_file(parser: &CodexParser, file: &PathBuf) -> Result<ParseResult> {
